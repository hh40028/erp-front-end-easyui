                    ...
                    <table style="width:100%;border:0">
                        ...
                        <tr>
                            <td style="width:100%;text-align: left" colspan="3">
                                <LinkButton style="margin-right: 20px" @click="open('审核通过')">通过审核</LinkButton>
                                <LinkButton style="margin-right: 20px" @click="open('驳回')">驳回</LinkButton>
                            </td>
                        </tr>
                    </table>
                </div>
...
export default {
    ...
    methods: {
        ...
        send() {
            ...
            this.confirm(this.operationname+',确认吗?', function () {
