    ...
    <Layout bodyCls="f-column" style="height: calc(100vh - 52px)" :border="false">
        ...
        <LayoutPanel region="center" style="height:100%" bodyCls="f-column" :border="false">
            <DataGrid :data="data" style="width:100%;height:250px" :border="false"
                ...
                <GridColumn field='number' title='编号' width="120" align="center"></GridColumn>
                <GridColumn field='name' title='物流名称' width="120" align="center"></GridColumn>
                <GridColumn field='typename' title='物流类型' width="120" align="center"></GridColumn>
                <GridColumn field='contacts' title='联系人' width="120" align="center"></GridColumn>
                <GridColumn field='tel' title='联系电话' width="120" align="center"></GridColumn>
                <GridColumn field='freightWay' title='货运方式' width="120" align="center"></GridColumn>
            ...
            <Dialog ref="d1" closed
                ...
                <div class="col-6 p-t-15 p-l-15 p-r-15">
                    ...
                    <select class="form-control" v-model="obj.type">
                        <option v-for="type in logisticsTypeList" :key="type.id" :value="type.id">{{type.name}}</option>
                    </select>
                </div>
                <div class="col-6 p-t-15 p-l-15 p-r-15">
                    <label>联系人</label><br>
                ...
                <div class="col-6 p-t-15 p-l-15 p-r-15">
                    <label>货运方式</label><br>
                    <input type="text" v-model="obj.freightWay" class="form-control">
                </div>
...
export default {
    ...
    methods: {
        ...
        loadLogisticsType(){
            let vm = this;
            this.getData("logisticsType/getList", {}, function (data) {
                vm.logisticsTypeList=data;
            })
        },
