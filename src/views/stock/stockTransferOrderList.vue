    ...
    <Layout bodyCls="f-column" style="height: calc(100vh - 52px)" :border="false">
        ...
        <LayoutPanel region="center" style="height:100%" bodyCls="f-column" :border="false">
            <DataGrid :columnResizing="true" :bodyStyle="{padding:'5px',border:0}"
                ...
                <GridColumn field="outWarehouseName" title="出货仓库" align="center"></GridColumn>
                <GridColumn field="inWarehouseName" title="入货仓库" align="center"></GridColumn>
                <GridColumn field="transferTime" title="调拨日期" align="center"></GridColumn>
                ...
                <template slot="detail" slot-scope="scope" :border="false">
                    <div style="padding: 3px;background-color: #fef7ce">
                        ...
                        <DataGrid :data="scope.row.items" :border="false"
                            ...
                            <GridColumn field="count" title='调拨数量' width="150" align="center"></GridColumn>
...
export default {
    ...
    methods: {
        ...
        loadPage(pageNumber, pageSize) {
            ...
            this.loading = true;
            let vm = this;
            this.$root.getData("stockTransferOrder/getQueryList", {
                limit: pageSize,
        ...
        add() {
            this.$router.push('newStockTransferOrder');
        },
        edit() {
        ...
        loadItems(obj) {
            let vm = this;
            this.getData("stockTransferOrderChild/getMaps", {pid: obj.id}, function (data) {
