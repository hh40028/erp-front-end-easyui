...
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.sendPay" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">订单标识</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.sendPay}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--            &lt;!&ndash;            <div v-if="obj.paymentCategory" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">支付分类: COD, NON_COD</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.paymentCategory}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
...
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.provinceId" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">省份id</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.provinceId}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--            <div v-if="obj.provinceName" class="col-12 p-t-15 p-l-15 p-r-15">-->
<!--                <label class="f-bold">省份名称</label><br>-->
<!--                <div>{{ obj.provinceName }}</div>-->
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.cityId" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">市id</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.cityId}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--            <div v-if="obj.cityName" class="col-12 p-t-15 p-l-15 p-r-15">-->
<!--                <label class="f-bold">市名称</label><br>-->
<!--                <div>{{ obj.cityName }}</div>-->
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.countyId" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">县id</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.countyId}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--            <div v-if="obj.countyName" class="col-12 p-t-15 p-l-15 p-r-15">-->
<!--                <label class="f-bold">县名称</label><br>-->
<!--                <div>{{ obj.countyName }}</div>-->
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.townId" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">镇id</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.townId}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
...
<!--            </div>-->
<!--            &lt;!&ndash;            <div v-if="obj.vendorStoreId" class="col-12 p-t-15 p-l-15 p-r-15">&ndash;&gt;-->
<!--            &lt;!&ndash;                <label class="f-bold">商家仓id</label><br>&ndash;&gt;-->
<!--            &lt;!&ndash;                <div>{{obj.vendorStoreId}}</div>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
...
<!--        </LayoutPanel>-->
        <LayoutPanel region="north" :border="false">
            <Panel :bodyStyle="{padding:'8px'}" :border="false">
                ...
                <select class="form-control" v-model="mainBodyId" style="width: 180px;margin-left: 0px" @change="loadPage(1,pageSize)">
                    <option v-for="mainBody in mainBodyList" :key="mainBody.id" :value="mainBody.id">{{ mainBody.name }}</option>
                </select>
                <select class="form-control" v-model="operatorState" style="width: 120px;margin-left: 20px" @change="loadPage(1,pageSize)">
                    <option v-for="operatorState in operatorStates" :key="operatorState.id" :value="operatorState.id">{{ operatorState.title }}</option>
                </select>
                <select class="form-control" v-model="refundSourceFlag" style="width: 120px;margin-left: 20px" @change="loadPage(1,pageSize)">
                    <option v-for="refundSourceFlag in refundSourceFlags" :key="refundSourceFlag.id" :value="refundSourceFlag.id">{{ refundSourceFlag.title }}</option>
                </select>
        ...
        <LayoutPanel region="center" style="height:100%" bodyCls="f-column" :border="false">
            <DataGrid :data="data" style="width:100%;height:250px" :border="false"
                ...
                <GridColumn field='mainBodyName' title='主体名称' width="160" align="center" :sortable="true"></GridColumn>
                ...
                <GridColumn field='updateDate' title='递交时间' width="160" align="center" :sortable="true"></GridColumn>
                <GridColumn field='outStock' title='出库' width="100" align="center" :sortable="true">
                    <template slot="body" slot-scope="scope">
                ...
                <GridColumn field='delivery' title='发货' width="100" align="center" :sortable="true">
                    <template slot="body" slot-scope="scope">
                ...
                <GridColumn field='orderCreateDate' title='订单时间' width="160" align="center" :sortable="true"></GridColumn>
                <GridColumn field='createDate' title='通知时间' width="160" align="center" :sortable="true"></GridColumn>
                                ...
                                <Layout bodyCls="f-column" style="height: calc(100vh - 52px)" :border="false">
                                    <LayoutPanel region="center" style="height:100%" bodyCls="f-column" :border="false">
                                        <DataGrid :data="items" :border="false"
                                            ...
                                            <GridColumn field='username' title='负责人' width="60" align="center"></GridColumn>
        ...
        <Dialog ref="viewImgDlg" closed
                ...
                :modal="true">
            <viewImgs ref="viewImgs" :wareid="itemObj.sku" @getImgPath="getImgPath"></viewImgs>
        </Dialog>
...
export default {
    ...
    components: {
        filterList, selectCommodity, selectSupplier, viewImgs, selectLogisticsType
    },
    created: function () {
    ...
    methods: {
        ...
        loadPage(pageNumber, pageSize) {
            ...
            this.$root.getData("orderForm/getQueryList", {
                ...
                refundSourceFlag: this.refundSourceFlag,
            }, function (data) {
                vm.total = data.total;
                ...
                data.children.forEach(function (e) {
                    ...
                    states.forEach(function (s) {
                        if (s.keyname === 'orderState' && e.orderState === s.code) {
                            vm.$set(e, 'orderStateName', s.name);
                        }
                        if (s.keyname === 'operatorState' && e.operatorState === s.code) {
                            vm.$set(e, 'operatorStateName', s.name);
                        }
                        if (s.keyname === 'refundSourceFlag' && e.refundSourceFlag === s.code) {
                            vm.$set(e, 'refundSourceFlagName', s.name);
                        }
                    })
                })
                vm.loading = false;
